...
echo $i" |"$pu" FACEBOOK :"$ku" Bucin ID.     "$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [TUHAN YANG MAHA ESA]        "$i"  |"
echo $i" |"$cy"            ~ {Sanes Tiang Pro}             "$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 085606xxxxxx"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" tu4nfl4y@gmail.com"$i".         |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"BUTTERFL4Y"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 2
echo $ku"WhatsApp :"$i" 0858606xxxxxx"
echo $ku"Facebook :"$i" Bucin ID"
sleep 2
